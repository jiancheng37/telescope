...
export function ReportActions({ reportId, publicPath, canConfigureMessages = false, initialIncludeMessages = false }: { reportId?: string; publicPath?: string; canConfigureMessages?: boolean; initialIncludeMessages?: boolean }) {
