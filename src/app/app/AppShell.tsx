...
const links = [
  { href: dashboardUrl(), paths: ["/", "/app"], label: "Dashboard" },
  { href: dashboardUrl("/new"), paths: ["/new", "/app/new"], label: "New analysis" },
  { href: dashboardUrl("/settings"), paths: ["/settings", "/app/settings"], label: "Settings" },
];

function linkIsActive(pathname: string, paths: string[]): boolean {
